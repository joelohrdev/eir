        ...
        <div class="block hover:bg-gray-50">
            <div class="flex items-center px-4 py-4 sm:px-6">
                ...
                <div class="flex">
                    ...
                    @else
                        <div x-data="{ tooltip: false }" class="relative inline-flex">
                            <button onclick="Livewire.emit('openModal', 'writing-sample-modal', {{ json_encode(['student' => $student->id]) }})" x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false" class="flex-shrink-0 pr-2">
